...
var World = {
	...
	requestDataFromServer: function requestDataFromServerFn(lat, lon) {
		...
		//		var dataFilter = 'where={"location":{"$nearSphere":{"__type":"GeoPoint","latitude":' + lat + ',"longitude":' + lon + '},"$maxDistanceInMiles":10.0}}';
				var dataFilter = 'where={"location":{"$nearSphere":{"__type":"GeoPoint","latitude":' + lat + ',"longitude":' + lon + '},"$maxDistanceInKilometers":5.0}}&limit=10';
