...
function Marker(poiData) {
    ...
    this.markerDrawable_idle = new AR.ImageDrawable(World.markerDrawable_idle, 3.0, {
        zOrder: 0,
        opacity: 0.7,
    ...
    this.markerDrawable_selected = new AR.ImageDrawable(World.markerDrawable_selected, 3.0, {
        zOrder: 0,
        opacity: 0.0,
        offsetY: offsetY_clustering,
        onClick: null
    ...
    this.markerDrawable_hide = new AR.ImageDrawable(World.markerDrawable_hide, 0.8, {
        zOrder: 0,
        offsetX: 3.0,
        opacity: 0.7,
        offsetY: -1.75 + offsetY_clustering,
        enabled: true,
        onClick: Marker.prototype.hideObject(this)
    });

    
    this.titleLabel = new AR.Label(poiData.name.trunc(7), 0.6, {
        zOrder: 1,
        offsetX: 0.6,
        offsetY: 0.30 + offsetY_clustering,
        style: {
            textColor: '#00144d',
    ...
    this.distanceLabel = new AR.Label(poiData.distance, 0.4, {
        zOrder: 1,
        offsetX: 0.6,
        offsetY: -0.65 + offsetY_clustering,
        style: {
            textColor: '#00144d'
        }
    });
    ...
    */
    this.markerObject = new AR.GeoObject(markerLocation, {
        drawables: {
            cam: [this.markerDrawable_idle, this.markerDrawable_selected, this.markerDrawable_hide, this.titleLabel, this.distanceLabel],
...
Marker.prototype.setSelected = function(marker) {
    ...
    document.location = "architectsdk://viewShowRoutePlaces?latitude=" + marker.poiData.latitude + "&longitude=" + marker.poiData.longitude + "&placeName=" + marker.poiData.name + "&placeId=" + marker.poiData.id;
    ...
    if (marker.animationGroup_selected === null) {
        ...
        var showSelectedDrawableAnimation = new AR.PropertyAnimation(marker.markerDrawable_selected, "opacity", null, 0.9, kMarker_AnimationDuration_ChangeDrawable);
        ...
        */
        marker.animationGroup_selected = new AR.AnimationGroup(AR.CONST.ANIMATION_GROUP_TYPE.PARALLEL, [hideIdleDrawableAnimation, showSelectedDrawableAnimation, idleDrawableResizeAnimation, selectedDrawableResizeAnimation, titleLabelResizeAnimation, distanceLabelResizeAnimation]);
    }
    ...
    // disables the hide Button
    marker.markerDrawable_hide.enabled = false;
...
Marker.prototype.setDeselected = function(marker) {
    ...
    document.location = "architectsdk://resetMapPlacesAround?name=" + marker.poiData.name;

    marker.markerObject.drawables.radar = marker.radardrawables;

    World.updateStatusMessage("Select a place", false);
    ...
    if (marker.animationGroup_idle === null) {
        ...
        var showIdleDrawableAnimation = new AR.PropertyAnimation(marker.markerDrawable_idle, "opacity", null, 0.7, kMarker_AnimationDuration_ChangeDrawable);
        ...
        /*
            There are two types of AR.AnimationGroups. Parallel animations are running at the same time, sequentials are played one after another. This example uses a parallel AR.AnimationGroup.
        */
        marker.animationGroup_idle = new AR.AnimationGroup(AR.CONST.ANIMATION_GROUP_TYPE.PARALLEL, [showIdleDrawableAnimation, hideSelectedDrawableAnimation, idleDrawableResizeAnimation, selectedDrawableResizeAnimation, titleLabelResizeAnimation, distanceLabelResizeAnimation]);
    }
    ...
    // enables the hide Button
    marker.markerDrawable_hide.enabled = true;
