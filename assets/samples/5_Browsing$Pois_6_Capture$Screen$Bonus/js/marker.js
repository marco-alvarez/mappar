...
function Marker(poiData) {
    ...
    */
    ...
    this.titleLabel = new AR.Label(poiData.title.trunc(12), 0.4, {
        zOrder: 1,
        offsetY: 0.10 + offsetY_clustering,
        style: {
            textColor: '#FFFFFF'
        }
    });
    ...
    this.descriptionLabel = new AR.Label(poiData.description.trunc(15), 0.35, {
        zOrder: 1,
        offsetY: -0.55 + offsetY_clustering,
        style: {
            textColor: '#FFFFFF'
        }
    });
    ...
    this.distanceLabel = new AR.Label(poiData.distance, 0.30, {
        zOrder: 1,
        offsetY: -0.45 + offsetY_clustering,
        style: {
            textColor: '#FFFFFF'
        }
    });
    ...
    */
    this.markerObject = new AR.GeoObject(markerLocation, {
        drawables: {
            cam: [this.markerDrawable_idle, this.markerDrawable_selected, this.titleLabel, this.distanceLabel],
...
Marker.prototype.setDeselected = function(marker) {
    ...
    $("#audioIcon").css("display", "inline-block");
    $("#videoIcon").css("display", "inline-block");

    World.onStopCurrentAudio();
